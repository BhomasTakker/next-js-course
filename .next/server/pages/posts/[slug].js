...
// EXTERNAL MODULE: external "react-syntax-highlighter/dist/cjs/styles/prism/atom-dark"
var atom_dark_ = __webpack_require__("h1sd");
var atom_dark_default = /*#__PURE__*/__webpack_require__.n(atom_dark_);

// EXTERNAL MODULE: ./node_modules/next/image.js
var next_image = __webpack_require__("Aiso");
var image_default = /*#__PURE__*/__webpack_require__.n(next_image);

// EXTERNAL MODULE: ./components/posts/post-detail/post-header.module.css
var post_header_module = __webpack_require__("QF0w");
var post_header_module_default = /*#__PURE__*/__webpack_require__.n(post_header_module);

// CONCATENATED MODULE: ./components/posts/post-detail/post-header.js
...
const PostHeader = props => {
  ...
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])("header", {
    className: post_header_module_default.a.header,
...
// EXTERNAL MODULE: ./components/posts/post-detail/post-content.module.css
var post_content_module = __webpack_require__("IV94");
var post_content_module_default = /*#__PURE__*/__webpack_require__.n(post_content_module);
...
// CONCATENATED MODULE: ./components/posts/post-detail/post-content.js
...
external_react_syntax_highlighter_["PrismLight"].registerLanguage("js", javascript_default.a);
external_react_syntax_highlighter_["PrismLight"].registerLanguage("css", css_default.a);
...
const PostContent = props => {
  ...
  const customRenderers = {
    ...
    p(paragraph) {
      ...
      if (node.children[0].tagName === "img") {
        ...
        console.log("What are we doing?" + image.properties.src);
    ...
    code(code) {
      ...
      return /*#__PURE__*/Object(jsx_runtime_["jsx"])(external_react_syntax_highlighter_["PrismLight"], {
        style: atom_dark_default.a,
        language: language,
        children: children
      });
    }
  ...
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])("article", {
    className: post_content_module_default.a.content,
    children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])(post_header, {
      title: post.title,
      image: imagePath
    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])(external_react_markdown_default.a, {
...
var post_util = __webpack_require__("S+zA");
...
const PostDetailPage = props => {
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])(external_react_["Fragment"], {
    ...
    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])(post_content, {
      post: props.post
    })]
  });
};
...
function getStaticProps(context) {
  ...
  const postData = Object(post_util["c" /* getPostData */])(slug);
  return {
    props: {
      post: postData
    },
...
function getStaticPaths() {
  const paths = Object(post_util["d" /* getPostFiles */])();
...
/* harmony default export */ var _slug_ = __webpack_exports__["default"] = (PostDetailPage);
...
// Exports
module.exports = {
	"content": "post-content_content__3fltc",
	"image": "post-content_image__I-Qr2"
};
...
// Exports
module.exports = {
	"header": "post-header_header__2ezzj"
};
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return getPostFiles; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return getPostData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getAllPosts; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getFeaturedPosts; });
...
const getPostData = postIdentifier => {
  ...
  const filePath = path__WEBPACK_IMPORTED_MODULE_1___default.a.join(postsDirectory, `${postSlug}.md`);
  const fileContent = fs__WEBPACK_IMPORTED_MODULE_0___default.a.readFileSync(filePath, "utf-8");
  const {
    data,
    content
